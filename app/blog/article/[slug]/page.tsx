...
const articles = [
  {
    ...
    authorRole: "Writer",
    authorBio: "Karishmaa Siddharthan is a writer specializing in the history of scientific discovery. Medically reviewed by Jessica Broodryk, OD, FAAO, an experienced optometrist dedicated to advancing vision care research.",
  ...
  },
  {
    ...
    authorRole: "Writer",
    authorBio: "Britney Nguyen is a writer focused on debunking everyday myths. Medically reviewed by Jessica Broodryk, OD, FAAO, an experienced optometrist dedicated to advancing vision care research.",
    authorImage: "/placeholder.webp",
    date: "July 16, 2025",
    category: "Eye Health",
    content: [
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-white">
            <div className="mb-6">
              ...
              <p className="text-lg md:text-xl italic text-gray-100 mb-6">
                {article.subtitle}
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-white text-lg">By {article.author}</p>
                  <p className="text-sm text-gray-200">Medically reviewed by Jessica Broodryk, OD, FAAO</p>
                </div>
              </div>
            ...
            <article className="prose prose-lg dark:prose-invert max-w-none">
              {article.content.map((section, index) => {
                if (section.type === "text") {
                  return <p key={index} className="mb-6 text-gray-700 leading-relaxed">{section.value}</p>;
                } else if (section.type === "heading") {
                  return <h2 key={index} className="text-3xl font-bold mt-10 mb-4 text-gray-900 underline decoration-custom-darkBlue">{section.value}</h2>;
                  ...
                  return (
                    <figure key={index} className="my-8">
                      ...
                      {section.caption && (
                        <figcaption className="mt-2 text-center text-sm text-gray-500 italic">{section.caption}</figcaption>
                      )}
                    </figure>
                  );
                }
